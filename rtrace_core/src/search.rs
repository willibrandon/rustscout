...
use crate::results::{SearchResult, FileResult, Match};
...
pub fn search(config: &Config) -> io::Result<SearchResult> {
    ...
    if !small_files.is_empty() {
        ...
        results.into_iter().for_each(|r| final_result.add_file_result(r));
    }
